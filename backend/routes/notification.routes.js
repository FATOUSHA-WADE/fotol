 ...
 * @access Private
 */
exports.routesNotification.get('/', auth_middleware_1.verifierToken, notification_controller_1.ControleurNotification.obtenirPourUtilisateur);
/**
 * @route POST /api/notifications
 * @desc Créer une nouvelle notification
 * @access Private (Admin/Modérateur)
 */
exports.routesNotification.post('/', auth_middleware_1.verifierToken, (0, auth_middleware_1.verifierRole)(message_1.RoleUtilisateur.MODERATEUR, message_1.RoleUtilisateur.ADMINISTRATEUR), notification_controller_1.ControleurNotification.creer);
/**
