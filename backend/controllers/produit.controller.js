        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const donneesProduit = {
                    ...
                    imageUrl: imageUrl || ((_d = req.file) === null || _d === void 0 ? void 0 : _d.path) || (photoFile === null || photoFile === void 0 ? void 0 : photoFile.path) || '',
    ...
    static obtenirMesProduits(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const filtres = Object.assign(Object.assign({ utilisateurId }, (typeof statut === 'string' && { statut })), { page: parseInt(page), limite: parseInt(limite) });
                const resultat = yield produit_service_1.ServiceProduit.obtenirTous(filtres);
                return res.status(200).json(resultat);
            }
            catch (error) {
